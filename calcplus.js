...
function toNumberProperties(item) {
    switch (typeof item) {
        case "number":
            return define(item + "");
        case "string":
...
function shouldRun(num1, num2) {
    if (powermode) {
        ...
        if (num1.length > maxNumberLength || num1.includes("."))
            return true;
        if (num2 === undefined)
            return false;
        ...
        if (num2.length > maxNumberLength || num1.includes("."))
            return true;
        return false;
    }
    return true;
...
function DIVIDE(num1, num2, maxD = maxDecimalLength, i = 1) {
    if (shouldRun(num1, num2)) {
        if (typeof num1 === "number")
            num1 = define(num1 + "");
        else if (typeof num1 === "string")
